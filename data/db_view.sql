...
CREATE VIEW LocationsPrixTotal(numero_location, date_dep_location, date_arr_location,adresse_dep_location, 
	adresse_arr_location,  numero_client, numero_employe, prixTotal_location, duree)AS
	...
	numero_client,
	numero_employe,
    julianday(date_arr_location)-julianday(date_dep_location) AS duree
    FROM Locations
	...
	numero_client,
	numero_employe,
    Sum(duree*PrixTrotinette) AS prixTotal_location,
	duree
